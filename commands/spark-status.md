---
description: Dashboard showing current project progress across all SparkKit phases. Reads handoff documents and produces a status overview with decisions, risks, and next steps.
---
