---
description: Resume an existing SparkKit project from uploaded handoff documents. Identifies where the project left off, detects conflicts, confirms state, and routes to the next phase.
---
