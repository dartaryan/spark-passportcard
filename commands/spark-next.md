---
description: Advance to the next phase of the SparkKit pipeline. Enforces gate checks before allowing progression and routes to the corresponding phase skill.
---
