---
description: Single-session viability check that produces a condensed Idea Viability Report with go/no-go recommendation. The try-before-you-buy mode — test an idea in 30 minutes without the full pipeline.
---
